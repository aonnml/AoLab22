...
LRESULT CALLBACK WndProc(HWND hwnd, UINT Message, WPARAM wParam, LPARAM lParam) {
    switch(Message) {
        case WM_CREATE: {
            ...
            hwndNum1 = CreateWindowEx(WS_EX_CLIENTEDGE, "EDIT", "", WS_CHILD | WS_VISIBLE, 10, 40, 100, 25, hwnd, NULL, NULL, NULL);
            hwndNum2 = CreateWindowEx(WS_EX_CLIENTEDGE, "EDIT", "", WS_CHILD | WS_VISIBLE, 10, 70, 100, 25, hwnd, NULL, NULL, NULL);
            hwndAdd = CreateWindow("BUTTON", "+", WS_CHILD | WS_VISIBLE, 120, 40, 50, 25, hwnd, NULL, NULL, NULL);
            hwndSub = CreateWindow("BUTTON", "-", WS_CHILD | WS_VISIBLE, 180, 40, 50, 25, hwnd, NULL, NULL, NULL);
            hwndMul = CreateWindow("BUTTON", "*", WS_CHILD | WS_VISIBLE, 120, 70, 50, 25, hwnd, NULL, NULL, NULL);
            hwndDiv = CreateWindow("BUTTON", "/", WS_CHILD | WS_VISIBLE, 180, 70, 50, 25, hwnd, NULL, NULL, NULL);
